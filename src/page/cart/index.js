...
var page = {
    ...
    bindEvent : function(){
        ...
        $(document).on('click', '.select', function(){
            var $this = $(this),
                productId = $this.parents('.table-list').data('product-id');
            // 选中
            if($this.is(':checked')){
        ...
        $(document).on('click', '.cart-delete', function(){
            if(window.confirm('确认要删除该商品？')){
                var productId = $(this).parents('.table-list').data('product-id');
        ...
        $(document).on('click', '.delete-select', function(){
            if(window.confirm('确认要删除选中的商品？')){
                ...
                for(var i = 0, iLength = $selectedItem.length; i < iLength; i ++){
                    arrProductIds
                        .push($($selectedItem[i]).parents('.table-list').data('product-id'));
                }
